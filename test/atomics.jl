...
@noinline function _test_field_operators(r)
    ...
    @test replacefield!(r, :x, 123_1 % UInt, T(123_30), :sequentially_consistent, :sequentially_consistent) === Pair{TT,Bool}(T(123_1), false)
    @test replacefield!(r, :x, T(123_1), T(123_30), :sequentially_consistent, :sequentially_consistent) === Pair{TT,Bool}(T(123_1), true)
    @test getfield(r, :x, :sequentially_consistent) === T(123_30)
    @test replacefield!(r, :x, T(123_1), T(123_1), :sequentially_consistent, :sequentially_consistent) === Pair{TT,Bool}(T(123_30), false)
    @test getfield(r, :x, :sequentially_consistent) === T(123_30)
...
@noinline function _test_field_orderings(r, x, y)
    ...
    @test replacefield!(r, :y, x, y, :not_atomic, :not_atomic) === Pair{TT,Bool}(x, true)
    @test replacefield!(r, :y, x, y, :not_atomic, :not_atomic) === Pair{TT,Bool}(y, x === y)
    @test replacefield!(r, :y, y, y, :not_atomic) === Pair{TT,Bool}(y, true)
    @test replacefield!(r, :y, y, y) === Pair{TT,Bool}(y, true)
    ...
    @test replacefield!(r, :x, x, y, :sequentially_consistent, :sequentially_consistent) === Pair{TT,Bool}(x, true)
    @test replacefield!(r, :x, x, y, :sequentially_consistent, :sequentially_consistent) === Pair{TT,Bool}(y, x === y)
    @test replacefield!(r, :x, y, x, :sequentially_consistent) === Pair{TT,Bool}(y, true)
    nothing
end
