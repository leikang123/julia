...
let p = Ptr{Nothing}(0)
    ...
    @test Core.Intrinsics.atomic_pointerreplace(p, nothing, nothing, :sequentially_consistent, :sequentially_consistent) === Pair(nothing, true)
    @test Core.Intrinsics.atomic_pointerreplace(p, missing, nothing, :sequentially_consistent, :sequentially_consistent) === Pair(nothing, false)
end
    ...
    GC.@preserve r begin
        (function (::Type{TT}) where TT
            ...
            if sizeof(r) > 8
                ...
                @test Core.Intrinsics.atomic_pointerreplace(p, T(1), T(100), :sequentially_consistent, :sequentially_consistent) === Pair{TT,Bool}(T(1), true)
                @test Core.Intrinsics.atomic_pointerref(p, :sequentially_consistent) === T(100)
                @test Core.Intrinsics.atomic_pointerreplace(p, T(1), T(1), :sequentially_consistent, :sequentially_consistent) === Pair{TT,Bool}(T(100), false)
                @test Core.Intrinsics.atomic_pointerref(p, :sequentially_consistent) === T(100)
                ...
                @test Core.Intrinsics.atomic_pointerreplace(p, S(100), T(2), :sequentially_consistent, :sequentially_consistent) === Pair{TT,Bool}(T(103), false)
            ...
            if TT === Any
                ...
                @test Core.Intrinsics.atomic_pointerreplace(p, T(100), S(2), :sequentially_consistent, :sequentially_consistent) === Pair{TT,Bool}(S(100), false)
                @test Core.Intrinsics.atomic_pointerreplace(p, S(100), T(2), :sequentially_consistent, :sequentially_consistent) === Pair{TT,Bool}(S(100), true)
